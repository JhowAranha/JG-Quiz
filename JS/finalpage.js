document.addEventListener("DOMContentLoaded", () => {
    ...
    if (score <= 5) {
        ...
        congratsTitleDOM.innerText = "Excelente!";
        congratsSubtitleDOM.innerText = "Seu conhecimento bíblico é impressionante! Continue firme em sua caminhada, compartilhando e vivendo a Palavra no dia a dia.";
        verseDOM.innerText = '📖"Bem-aventurados os que ouvem a Palavra de Deus e a guardam." (Lucas 11:28)';
    }
